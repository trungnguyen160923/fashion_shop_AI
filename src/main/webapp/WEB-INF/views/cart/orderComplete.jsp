...
<link href="<c:url value='/resources/home/dist/css/reset.css' />"
	rel="stylesheet">
<link
	href="<c:url value='/resources/home/dist/css/orderComplete.css' />"
	rel="stylesheet">
<link rel="stylesheet"
			...
			<div class="container">
				...
				<div class="order-results">
					<div class="overview-item">
						<div class="overview-name">ORDER NUMBER:</div>
						<div class="overview-value">4935</div>
					</div>



					<div class="overview-item">
						<div class="overview-name">STATUS:</div>
						<div class="overview-value">Processing</div>
					</div>

					<div class="overview-item">
						<div class="overview-name">DATE:</div>
						<div class="overview-value">November 20, 2020</div>
					</div>

					<div class="overview-item">
						<div class="overview-name">EMAIL:</div>
						<div class="overview-value">12345@gmail.com</div>
					</div>

					<div class="overview-item">
						<div class="overview-name">TOTAL:</div>
						<div class="overview-value">$312.00</div>
					</div>

					<div class="overview-item">
						<div class="overview-name">PAYMENT METHOD:</div>
						<div class="overview-value">Cash on delivery</div>
					</div>
				</div>
				...
				<div class="order-details">
					<table>
						...
						<tr class="prod">
							<td>Beige knitted shoes x <span class="quantity">1</span>
							</td>
