...
<link href="<c:url value='/resources/home/dist/css/reset.css' />"
	rel="stylesheet">
<link href="<c:url value='/resources/home/dist/css/checkOut.css' />"
	rel="stylesheet">
<link rel="stylesheet"
						...
						<div class="row">
							<div class="col-8">
								<table class="shop-table">
									...
									<tbody>
										<c:forEach var="pd" items="${products}">
											<tr class="product">
												<td class="product-thumbnail"><img src="${pd.image}"
													alt=""></td>
												<td class="product-name">${pd.name}</td>
												<td class="product-subtotal"><fmt:formatNumber
														type="currency" currencySymbol="$ " value="${pd.price}" />
												</td>
												...
												<td class="product-price"><fmt:formatNumber
														value="${pd.price * pd.quantity}" pattern="0.00" /></td>
												<td class="product-close"><span class="btn-remove"><i
								...
								<div class="cart-action">
									<a href="home/products.htm" class="btn-back-home"><i
							...
							<div class="col-4">
								<div class="sidebar">
									...
									<div class="shipping useless">
										...
										<ul>
											<li><input name="ship" type="radio" id="rate"> <label
												for="rate">Flat rate</label></li>

											<li><input name="ship" type="radio" id="free"> <label
												for="free">Free shipping</label></li>

											<li><input name="ship" type="radio" id="local">
												<label for="local">Local pickup</label></li>
										</ul>
									</div>

									<div class="total">
										<label for="">Total</label> <span class="price">$426.99</span>
									</div>

									<div class="payment useless">
										<h3>Payment Methods</h3>
										<ul>
											<li><input type="radio" name="payment" id="check">
												<label for="check">Check payments</label></li>

											<li><input type="radio" name="payment" id="cash">
												<label for="cash">Cash on delivery</label></li>
										</ul>
									</div>

									<a href="cart/orderComplete.htm" class="btn-check-out">PLACE
										ORDER</a>
								</div>
							</div>
						</div>
