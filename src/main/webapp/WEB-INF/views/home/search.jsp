...
.main .banner {
  height: 250px;
  background: url("https://png.pngtree.com/background/20230612/original/pngtree-vintage-photo-frames-wallpaper-photo-3-picture-image_3183628.jpg") center center/cover;
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
  -webkit-box-align: center;
