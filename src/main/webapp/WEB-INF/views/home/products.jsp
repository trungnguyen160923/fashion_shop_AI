...
<link href="<c:url value='/resources/home/dist/css/reset.css' />"
	rel="stylesheet">
<link href="<c:url value='/resources/home/dist/css/products.css' />"
	rel="stylesheet">
<link rel="stylesheet"
				...
				<div class="row">
					<aside class="aside col-3">
						<div class="aside-header">
							<a href="home/index.htm">FILTER <i class="fa-solid fa-filter"></i></a>
						</div>
						...
						<div class="list">
							...
							<ul>
								<li><input type="checkbox" name="size" id="sizeXL">
									<label for="sizeXL">Extra Large</label></li>

								<li><input type="checkbox" name="size" id="sizeL">
									<label for="sizeL">Large</label></li>

								<li><input type="checkbox" name="size" id="sizeM">
									<label for="sizeM">Medium</label></li>

								<li><input type="checkbox" name="size" id="sizeS">
									<label for="sizeS">Small</label></li>
							</ul>
						</div>
						...
						<div class="list">
							...
							<ul>
								<li><input type="checkbox" name="color" id="black">
									<label for="black">Black</label></li>

								<li><input type="checkbox" name="color" id="blue">
									<label for="blue">Blue</label></li>

								<li><input type="checkbox" name="color" id="green">
									<label for="green">Green</label></li>

								<li><input type="checkbox" name="color" id="white">
						...
						<div class="list-products">
							<div class="row">
								...
								<c:if test="${catON == 'false' }">
									<c:forEach var="p" items="${prods}" begin="0"
										end="${prodsSize}" step="1">
										<div class="col-4 product">
											<div class="product-image">
												<img style="width: 100%; height: 100%;" src="${p.image }"
													alt="">
