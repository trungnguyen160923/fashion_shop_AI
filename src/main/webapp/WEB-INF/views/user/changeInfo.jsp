...
<body>
	...
	<aside class="aside">
		...
		<ul class="functions">
			...
			<li class="function"><a href="user/changepassword/{acc}.htm"
				class="">
					<div class="icon">
				...
				<div class="row">
					...
					<div class="col-4">
						...
						<label for="">Username:</label> <input type="text"
							...
							value="${acc.getUser_name() }" readonly> <label for="">Full
							name:</label> <input type="text" placeholder="FullName" name="name"
							value="${acc.getFullname() }"> <label for="">Email:</label>
						<input type="email" placeholder="Email" value="${acc.getEmail() }"
							readonly>
					...
					<div class="col-4">
						...
						<label for="">Birthday:</label> <input type="date"
							...
							value="${acc.getBirthday() }"> <label for="">Number:</label>
						<input type="number" placeholder="PhoneNumber" name="phone"
							value="${acc.getPhone() }"> <label for="">Address:</label>
