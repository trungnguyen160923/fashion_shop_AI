...
<link href="<c:url value='/resources/home/dist/css/reset.css' />"
	rel="stylesheet">
<link
	href="<c:url value='/resources/home/dist/css/userChangePass.css' />"
	rel="stylesheet">
<link rel="stylesheet"
...
<body>
	<aside class="aside">
		...
		<ul class="functions">
			<li class="function"><a href="user/userHome.htm" class="">
					<div class="icon">
						<i class="fa-solid fa-user"></i>
					</div> Information
			</a></li>

			<li class="function"><a href="user/changepassword.htm"
				class="active">
					<div class="icon">
