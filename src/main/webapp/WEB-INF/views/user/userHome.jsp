...
<link href="<c:url value='/resources/home/dist/css/reset.css' />"
	rel="stylesheet">
<link href="<c:url value='/resources/home/dist/css/userHome.css' />"
	rel="stylesheet">
<link rel="stylesheet"
...
<body>
	...
	<aside class="aside">
		...
		<ul class="functions">
			<li class="function"><a href="user/userHome.htm" class=" active">
					<div class="icon">
						<i class="fa-solid fa-user"></i>
					</div> Information
			</a></li>

			<li class="function"><a href="user/changepassword.htm" class="">
					<div class="icon">
	...
	<main class="main">
		<div class="main-header">
			...
			<div class="map">
				<a href="home/index.htm">Home</a> / <a href="user/userHome.htm">${acc.getFullname() }</a>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-4">
					...
					<label for="">Username:</label> <input type="text"
						placeholder="Username" value="${acc.getUser_name() }" readonly>

					<label for="">Full name:</label> <input type="text"
						placeholder="FullName" value="${acc.getFullname() }" readonly>

					<label for="">Email:</label> <input type="email"
						placeholder="Email" value="${acc.getEmail() }" readonly>
				...
				<div class="col-4">
					...
					<label for="">Birthday:</label> <input type="date"
						placeholder="Birthday" value="${acc.getBirthday() }" readonly>

					<label for="">Number:</label> <input type="number"
						placeholder="PhoneNumber" value="${acc.getPhone() }" readonly>

					<label for="">Address:</label> <input type="text"
						placeholder="Address" value="${acc.getAddress() }" readonly>
				</div>
			</div>
