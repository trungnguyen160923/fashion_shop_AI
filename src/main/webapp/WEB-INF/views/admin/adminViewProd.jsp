	...
	<main class="main">
		...
		<div class="main-content">
			<form action="admin/adminProducts.htm" method="post">
						...
						<div class="row info">
							...
							<div class="col-6 field name">
								<label for="">Category:</label> <input type="text"
									value="${p.getProductCategory().getNameCategory()}" readonly>
							</div>


							<div class="col-6 field name">
								<label for="">Name:</label> <input type="text"
									value="${p.name }" name="name" readonly>
							</div>

							<div class="col-6 field price">
								<label for="">Price:</label> <input type="number" id=""
									value="${p.price }" name="price" readonly>
							</div>


							<div class="col-6 field">
								<label for="">Image source:</label> <input type="text"
									value="${p.image }" readonly>
							</div>
				...
				<a href="admin/colorSize/${p.idProduct}.htm" class="col-6 btn-save"
					style="right: 160px;">Manage</a>
			</form>
