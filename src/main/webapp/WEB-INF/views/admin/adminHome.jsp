...
<link href="<c:url value='/resources/home/dist/css/reset.css' />"
	rel="stylesheet">
<link href="<c:url value='/resources/home/dist/css/adminHome.css' />"
	rel="stylesheet">
<link rel="stylesheet"
...
<body>
	...
	<aside class="aside">
		...
		<ul class="functions">
			<li class="function"><a href="admin/adminAccount.htm" class=" ">
					<div class="icon">
		...
		<div class="main-content">
			<div class="row">
				...
				<a href="admin/adminBill.htm" class="col-6 bill hx2">
					<h3>
						Report about <span class="bold">Bills</span>
					</h3>

					<div class="icon">
						<i class="fa-solid fa-chart-pie active"></i> <i
							class="fa-solid fa-file disable"></i>
				...
				<div class="col-6">
					<div class="row">
						...
						<a href="admin/adminAccount.htm" class="col-12 report hx1">
							<h3>
								Information about <span class="bold">Account</span>
							</h3>

							<div class="icon">
								<i class="fa-solid fa-user"></i> <i class="fa-solid fa-users"></i>
								<i class="fa-solid fa-user-gear"></i>
							</div>

							<p class="desc">View the report about ordered products
								recently</p>
						</a>
						...
						<a href="admin/adminProducts.htm" class="col-12 report hx1">
							<h3>
								Manage <span class="bold">Products</span>
							</h3>

							<div class="icon">
								<i class="fa-solid fa-shirt"></i> <i class="fa-solid fa-glasses"></i>
