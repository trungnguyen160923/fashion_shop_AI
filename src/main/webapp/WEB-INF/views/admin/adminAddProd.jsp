						...
						<div class="row info" style="position: relative;">
							...
							<div class="col-6 field price">
								<label for="">Price:</label> <input type="number" name="price"
									id="" placeholder="Type price here...">
							</div>



							<div class="col-6 field">
								<label for="">Image source:</label> <input type="text"
									name="image" id="" placeholder="Type image source here...">
							</div>

							<div class="col-6 field">
								<label for="">Brand:</label> <input type="text" name="brand"
									id="" placeholder="Type brand here...">
							</div>
							...
							<button class="col-6 btn" style="bottom: -40px;">Add
								product</button>
						</div>
					</div>
				</div>
